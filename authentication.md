...
You can use a [component](application-builders.md#component-authenticators) to register a default scheme:
...
Let's register this scheme with the authenticator with a [component](application-builders.md#component-authenticators):
