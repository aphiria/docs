...
* Trie-based solution makes it one of the fastest routing libraries out there (<a href="https://github.com/aphiria/aphiria/blob/1.x/src/Router/bin/benchmarks.php" target="_blank">~200% faster than FastRoute</a>)
